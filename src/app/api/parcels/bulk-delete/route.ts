...
/**
 * Delete multiple parcels at once.
 * Body: { ids: string[] }  or  { all: true } to delete every parcel.
 */
export async function POST(req: NextRequest) {
  ...
  if (all === true) {
    ...
    return NextResponse.json({ success: false, error: "Aucun colis sélectionné" }, { status: 400 })
  }
