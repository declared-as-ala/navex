...
const FIELDS = [
  ...
  { key: "verifyDelayDays", label: "Délai « À vérifier » (jours)", placeholder: "3" },
  { key: "navexLookupEndpoint", label: "Navex — endpoint de recherche colis", placeholder: "https://app.navex.tn/api/<token>/lookup" },
  { key: "navexStatusEndpoint", label: "Navex — endpoint paiements", placeholder: "https://app.navex.tn/api/<token>/status" },
]
